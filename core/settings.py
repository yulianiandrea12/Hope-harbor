...
ALLOWED_HOSTS        = [ 'localhost', 'localhost:85', '127.0.0.1', '34.148.67.175', env('SERVER', default='127.0.0.1') ]
CSRF_TRUSTED_ORIGINS = ['http://localhost:85', 'http://127.0.0.1', 'http://34.148.67.175', 'https://' + env('SERVER', default='127.0.0.1') ]
